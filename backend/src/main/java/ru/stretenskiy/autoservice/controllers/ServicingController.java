...
public class ServicingController {
    ...
    @GetMapping("/sum_cost")
    public ResponseEntity<CostServices> getSumCost(@RequestParam(name = "begin") String withDate,
        ...
        Optional<CostServices> costServicesOpt = servicingService.getSumCost(withDateSql, beforeDateSql);
        return costServicesOpt.map(ResponseEntity::ok)
